...
import { useLoadingNotifier } from '../../hooks/useLoadingNotifier.js';
...
import TurnstileCaptcha from '../../auxiliaries/captcha/TurnstileCaptcha.jsx';
    ...
    <div className='logSection'>
      <div className='signupContainer'>
        ...
        <Box component='form' className='signForm' onSubmit={submitForm} noValidate>
          ...
          { showCaptcha && (
            <TurnstileCaptcha siteKey={import.meta.env.VITE_TURNSTILE_SITEKEY} onVerify={setCaptchaToken}/>
          )}
