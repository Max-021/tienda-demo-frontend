    ...
    return (
        <form className='pwdChangeContainer' method='post' onSubmit={submitUpdatedPassword}>
            ...
            <div className='userInfoContainer pwdUserInfoContainer'>
                ...
                <TextField required name={'newPassword'} type={showNewPassword?'text':'password'} inputProps={{style:{padding:'12px'}}} value={userPwd.newPassword} onChange={handlePwd} disabled={!isChangePasswordActive}
                    InputProps={{endAdornment:(
                        <InputAdornment position='end'>
